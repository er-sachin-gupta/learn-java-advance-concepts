...
public class CarPriceEstimator {
    ...
    public double getSalePrice(String makeAndModel, int yearManufactured, double milesDriven,
        ...
        if (ageOfCar <= 10) {
            salePrice = salePrice - (ageOfCar * ((salePrice * 5) / 100));
        } else {
    ...
    public static void main(String[] args) {
        ...
        double salesPrice = carPriceEstimator.getSalePrice("ford ecosport", 2023, 60000.0, 2, true, false, true, false, false, true);
    }
}
